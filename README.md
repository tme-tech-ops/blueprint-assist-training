...
This training is organized into 21 sections, starting with a Quick Start for new users:
...
Full version history is maintained in [`docs/CHANGELOG.md`](docs/CHANGELOG.md).
