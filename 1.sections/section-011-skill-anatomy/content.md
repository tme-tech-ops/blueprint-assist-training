...
- **Runtime mode.** Each skill states how it runs. The dap-bpa skills run in IDE mode with shell access and tell the agent to use the `dap-bpa` CLI for operations.
...
2. **Section 4: Skills Overview** is the catalog of the seven skills and when to reach for each.
