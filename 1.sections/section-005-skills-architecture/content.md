...
When you run `dap-bpa setup-ide <ide>`, the tool installs a complete skill set into your agent. The following nine skills ship by default (current as of v0.31):
