...
Access and manage decision records and reasoning traces from blueprint authoring and deployment workflows.
...
- **CLI version**: this reference covers dap-bpa v0.29.3
